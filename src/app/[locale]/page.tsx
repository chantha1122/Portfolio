...
export default async function HomePage({ params }: Props) {
  ...
  const [profileRecord, activityRecords, skillRecords, toolRecords] = await Promise.all([
  ...
  const profile: PublicProfile = profileRecord
    ...
    : {
        ...
        headlineKm: null,
        shortBioEn: "A growing portfolio of projects, learning, teaching and practical technology work.",
        shortBioKm: null,
        bioEn: null,
        bioKm: null,
        currentRoleEn: "Software & AI Enthusiast",
        currentRoleKm: null,
        currentFocusEn: "Building useful digital products and practical AI experiences.",
        currentFocusKm: null,
        yearsExperience: 0,
        email: null,
        phone: null,
  ...
  const projectCount = activities.filter((activity) => activity.type === "PROJECT").length;
